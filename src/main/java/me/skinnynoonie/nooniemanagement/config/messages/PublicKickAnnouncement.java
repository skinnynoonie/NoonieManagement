...
@DefaultMessageConfigValue(defaultValue = "<aqua>{target}<gray> has been <white>kicked<gray> by <aqua>{issuer}<gray>.")
public record PublicKickAnnouncement(NameableUser target, NameableUser issuer) implements ConfigurableMessage {
